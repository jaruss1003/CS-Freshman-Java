 ...
 * @Description: Same program as MyConvert, but uses printf and limits conversion to 2 numbers after the decimal
...
class Measure {
 ...
 public static void main (String[]args) {
  ...
  if (desired_cm) {
   System.out.printf("%s: %.2f%n","Centimeters", +input_in_centimeters);
  }
  if (desired_in) {
   System.out.printf("%s: %.2f%n","Inches", +input_in_centimeters/2.54);
  }
  // TODO: similarly treat cases where desired_ft or desired_m
  if (desired_ft) { 
   System.out.printf("%s: %.2f%n","Feet", +input_in_centimeters/12/2.54); 
  }
  if (desired_m) { 
   System.out.printf("%s: %.2f%n","Meters", +input_in_centimeters/100); 
  }
 }
}
